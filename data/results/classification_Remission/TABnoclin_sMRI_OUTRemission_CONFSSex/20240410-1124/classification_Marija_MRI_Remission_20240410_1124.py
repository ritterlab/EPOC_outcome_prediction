...
class Config:
    ...
    H5_FILES = [
        ...
        #'/ritter/share/data/EPOC/h5_files/TAB_EEG_MRI_OUTRemission_CONFSSex.h5',
        #'/home/marijatochadse/2_scripts/EPOC_hdf5_file_creation/EPOC_fMRI_conf_sex_Remission.h5',
